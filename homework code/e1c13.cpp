...
{
    	cout<<"performers: "<<performers<<endl<<"label: "<<label<<endl<<"number of selections: "<<selections<<endl<<"playing time in minutes: "<<playtime<<endl<<endl;
}
...
{
	cout<<"majorworkers: "<<majorworkers<<endl<<"performers: "<<performers<<endl<<"label: "<<label<<endl<<"number of selections: "<<selections<<endl<<"playing time in minutes: "<<playtime<<endl<<endl;
}

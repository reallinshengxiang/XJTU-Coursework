														        ...
														        if(q==0)
																        {
																		               for(i=1;i<=3;i++) 
																				       			   {
																								   			        cout<<a[i].xuehao<<" "<<a[i].banji<<" "<<a[i].xingming<<" "<<a[i].chengji1<<" "<<a[i].chengji2<<" "<<a[i].chengji3<<endl;  
																															   }                   
																			               }
															        else
																	        {
																			               for(i=1;i<=3;i++)
																					                    {
																								                      if(i!=q)  cout<<a[i].xuehao<<" "<<a[i].banji<<" "<<a[i].xingming<<" "<<a[i].chengji1<<" "<<a[i].chengji2<<" "<<a[i].chengji3<<endl;   
																										                   }
																				                    cout<<"Are you sure(yes/no)?"<<endl;
																						                char cc;
																								           cin>>cc;
																									             if(cc=='n')
																											               {
																													                  for(i=1;i<=3;i++) cout<<a[i].xuehao<<" "<<a[i].banji<<" "<<a[i].xingming<<" "<<a[i].chengji1<<" "<<a[i].chengji2<<" "<<a[i].chengji3<<endl;   
																															            }
																										             }
}

...
CONFIG_PATH = "transformer_scripts/config.json"
...
def main():
    ...
    if args.resume_checkpoint:
        ...
        resume_ckpt_path = pathlib.Path(__file__).resolve().parent.parent / f"checkpoints_transformer/ckpt_iter{args.resume_checkpoint}.pt"

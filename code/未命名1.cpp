...
string load_status[10][3],store_status[10][3],add_status[10][10],mult_status[10][10],register_results[33];
string history_load_status[MAX_CLOCK][10][3],history_store_status[MAX_CLOCK][10][3],history_add_status[MAX_CLOCK][10][10],history_mult_status[MAX_CLOCK][10][10],history_register_results[MAX_CLOCK][33];
